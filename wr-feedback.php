<?php ob_start();?>
<?php require 'include/page-function.php';?>
...
<body>
<?php require('include/wr-header.php');?>
<?php include ('include/username.php'); ?>
<?php if ($_SESSION['user_type']=='w') {$user_id = true;?>
<div class="contdoo" >  
<section >
<div class="container">
...
?>
<div class="image-div"><form method="POST" action="" enctype="multipart/form-data"></div>
