...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><div class="maxio"></div></div><section id="work" >
<div class="container">
<div class="row">
<div class="col-lg-12">
...
$url = 'uploades/w-profile/'.$eimg.'.jpg';
$file_temp=compress_image($_FILES["files6"]['tmp_name'], $url, 70); 
header("Content-Transfer-Encoding: binary");
$u_id=$_SESSION['user_id'];
move_uploaded_file($file_temp, 'uploades/w-profile/'.$eimg.'.jpg');
mysql_query("INSERT INTO w_profile VALUES ('','$eimg.jpg','$u_id','$sDate') ");
echo"image uploaded <br/><br/>";
header("location:wr-pro.php");
} else  { 
