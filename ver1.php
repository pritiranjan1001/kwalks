...
if($z==sha1($ver2))
{
mysql_query("UPDATE pusers SET ver='1'WHERE  id=('$u_id')");
echo" <div class='row'> <h3>Your account has been successfully verified.
</h3>
<h5> <a href='signup-page.php'>click here</a> to login </h5>
</div>";	
}}}
else{
echo"<div class='row'> <h3>Invalid Link or Link has been expaired
</h3>
<h5>*tips: 'Please sign in again , if your account is not activated a new link will be send to your email account.' </h5>
</div>";
}															
?></div>        
</div>
