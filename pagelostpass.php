...
{ 
	$verify=$_POST['verify']; 
	$query1 = mysql_query("select * from puser where email='$verify' ");     	  
...
Clicking on this link will allow you to choose a new password for your account removing the old one.<br></p><br>
...
Your password won't be reset.</h5><br><br><h5>Thanks, </h5>
<h5>KWALKS Team </h5><br><br><br></div>
</html>
";
$headers = "MIME-Version: 1.0" . "\r\n";
$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
$headers .= 'From: <webmaster@example.com>' . "\r\n";
mail($verify,$subject,$message,$headers);
}
